...
class AddHouseViewController: UIViewController, UITextFieldDelegate {
    ...
    let realRealtorIDTF : UITextField = UITextField.createUITextField(UIColor.whiteColor().CGColor, autoSizingContraint: false)
    ...
    override func viewDidLoad() {
        ...
        let realID = UILabel()
        realID.text = "Realtor ID:"
        realID.setTranslatesAutoresizingMaskIntoConstraints(false)
        view.addSubview(realID)
        
        let leadingRealID =  NSLayoutConstraint(item: realID, attribute: NSLayoutAttribute.Leading, relatedBy: NSLayoutRelation.Equal, toItem: view, attribute: NSLayoutAttribute.Leading, multiplier: 1.0, constant: 10)
        let topRealID = NSLayoutConstraint(item: realID, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: sold, attribute: NSLayoutAttribute.Bottom, multiplier: 1.0, constant: 10)

        view.addSubview(realRealtorIDTF)
        
        let leadingRealRealtorTF =  NSLayoutConstraint(item: realRealtorIDTF, attribute: NSLayoutAttribute.Leading, relatedBy: NSLayoutRelation.Equal, toItem: soldTF, attribute: NSLayoutAttribute.Leading, multiplier: 1.0, constant: 0)
        let topRealRealtorTF = NSLayoutConstraint(item: realRealtorIDTF, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: soldTF, attribute: NSLayoutAttribute.Bottom, multiplier: 1.0, constant:10)
        let trailingRealRealtorTF = NSLayoutConstraint(item: realRealtorIDTF, attribute: NSLayoutAttribute.Trailing, relatedBy: NSLayoutRelation.Equal, toItem: soldTF, attribute: NSLayoutAttribute.Trailing, multiplier: 1.0, constant: 0)
        ...
        let topSaveButton = NSLayoutConstraint(item: saveButton, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: realID, attribute: NSLayoutAttribute.Bottom, multiplier: 1.0, constant:10)
        ...
        if (type == "Edit") {
            ...
            self.realRealtorIDTF.text = "\(houseInfo!.realtorID!)"
    ...
    func writeRecord() {
        ...
        record.setObject(self.realRealtorIDTF.text.toInt(), forKey: "RealtorID")
