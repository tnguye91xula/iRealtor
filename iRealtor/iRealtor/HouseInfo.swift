...
class HouseInfo: Printable, Equatable {
    var name: String?
    var bathrooms: Int?
    var bedrooms: Int?
    var houseID: Int?
    ...
    init(name: String, bathrooms: Int, bedrooms: Int, houseID: Int, location: CLLocation, price: Int, sold: Int, image: UIImage, rID: Int) {
        self.name = name
        self.bathrooms = bathrooms
        self.bedrooms = bedrooms
        self.houseID = houseID
    ...
    init(name: String, bathrooms: Int, bedrooms: Int, houseID: Int, address: String, price: Int, sold: Int, image: UIImage, rID: Int) {
        self.name = name
        self.bathrooms = bathrooms
        self.bedrooms = bedrooms
        self.houseID = houseID
