...
class AdminListRealtorsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UINavigationBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "ALL REALTORS IN DATABASE "
