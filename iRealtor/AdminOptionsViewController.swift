...
class AdminOptionsViewController: UIViewController {
  ...
  private var tbvc = UITabBarController()
     override func viewDidLoad() {
        ...
        NSLayoutConstraint.activateConstraints([topAddHouseButton,centerAddHouseButton, centerViewTitle, leadingViewTitle, centerViewTitle, topListHouseButton, centerListHouseButton, topAddRealtorButton, centerAddRealtorButton, topListRealtorButton, centerListRealtorButton])
